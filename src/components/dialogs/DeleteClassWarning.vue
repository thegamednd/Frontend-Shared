  ...
  <dialog ref="dialog" class="delete-dialog">
    <div class="dialog-content">
      <div class="modal-header">
        ...
        <h2>Permanently Delete Class</h2>
      ...
      <div class="modal-body">
        <p class="warning-message">
          You are about to permanently delete the class <strong>{{ className }}</strong>.
        </p>
        ...
        <div class="delete-warning">
          ...
          <div class="warning-text">
            <p>
              <strong>This action cannot be undone.</strong> The class will be permanently removed from the database and cannot be recovered.
            </p>
          </div>
        </div>
        ...
        <div class="acknowledgment-section">
          <label class="checkbox-label">
            ...
            />
            <span>I understand this will permanently delete <strong>{{ className }}</strong></span>
          </label>
        </div>
      </div>
